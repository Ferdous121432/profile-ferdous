...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex min-h-[30rem]  flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}>
      ...
      <div className="absolute top-1/2 w-[30rem] z-50 flex -translate-y-10  flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
